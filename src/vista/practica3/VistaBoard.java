...
public class VistaBoard extends javax.swing.JFrame {
	...
	private String RUTA = "C:\\hlocal\\Practica3\\src\\ImagenCartas\\";
    /**
...
*/
	...
	public void arranca() {
	  ...
	  public void setControlador(Controlador3 control) {
		 ...
		 /* jButton13.addActionListener(control);
		  jButton13.setActionCommand("ChangeCard" + " 6 0");
		  jButton14.addActionListener(control);
		  jButton14.setActionCommand("ChangeCard" + " 6 1");
		  jButton15.addActionListener(control);
		  jButton15.setActionCommand("ChangeCard" + " 7 0");
		  jButton16.addActionListener(control);
		  jButton16.setActionCommand("ChangeCard" + " 7 1");
    ...
    private void RandButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        paloRandom=(int) (Math.random()* 4 + 1);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaBoard().setVisible(true);
            }
        });
    }
