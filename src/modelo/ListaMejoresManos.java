	...
	public ListaMejoresManos(String[] manos) throws IOException {
		...
		lista.sort(new Comparator<MejorMano>() {
			...
			public int compare(MejorMano mano1, MejorMano mano2){
				if (mano1.getRank() > mano2.getRank()) return -1;
				else if (mano1.getRank() < mano2.getRank()) return 1;
					...
					if (mano1.getRank() == 2 || mano1.getRank() == 6){
						...
						if (aux1.getValor() > aux2.getValor())return -1;
						else if (aux1.getValor() < aux2.getValor()) return 1;
							...
							else return 1;//Si es full se ha llegado hasta el final, es el mismo por lo que son iguales
					}
					else if (aux1.getValor() > aux2.getValor()) return -1;
					else if (aux1.getValor() < aux2.getValor()) return 1;
					else{ 
